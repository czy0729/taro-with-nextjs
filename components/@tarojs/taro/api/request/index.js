...
/*
 * @Author: czy0729
 * @Date: 2021-02-26 23:32:57
 * @Last Modified by: czy0729
 * @Last Modified time: 2021-02-27 21:30:04
 */
import 'whatwg-fetch'
import jsonpRetry from 'jsonp-retry'
import { Link } from '@@/components/@tarojs/taro-api'
...
function _request(options) {
  ...
  if (methodUpper === 'GET' || methodUpper === 'HEAD') {
    ...
    const keyOfContentType = Object.keys(options.header).find(
